...
Development
---------------------
The Dash repo's [root README](github.com/sarmacoins/dash/blob/master/README.md) contains relevant information on the development process and automated testing.
